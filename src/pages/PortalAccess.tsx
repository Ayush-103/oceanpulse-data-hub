          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="text-center">
                <CardHeader>
                  <div className="p-3 bg-green-500 rounded-lg w-fit mx-auto mb-2">
                    <Database className="h-5 w-5 text-white" />
                  </div>
                  <CardTitle className="text-lg">Data Platform</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="text-center">
                <CardHeader>
                  <div className="p-3 bg-blue-500 rounded-lg w-fit mx-auto mb-2">
              ...
              <Card className="text-center">
                <CardHeader>
                  <div className="p-3 bg-orange-500 rounded-lg w-fit mx-auto mb-2">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Scheduled maintenance 2AM-4AM IST
                  </p>
                </CardContent>
              </Card>
            </div>
